...
ActiveRecord::Schema.define(version: 20150219145208) do
  ...
  add_index "businesses_keywords", ["business_id", "keyword_id"], name: "index_businesses_keywords_on_business_id_and_keyword_id", using: :btree
  ...
  add_index "time_slots", ["business_id"], name: "index_time_slots_on_business_id", using: :btree
